...
def major_segments(s):
    ...
    :return: a set of split segments
    """
    major_breaks = ' '
    last = -1
    results = set()
...
def minor_segments(s):
    """
    Perform minor segmenting on a string. This is like major segmenting, except it also
    captures from the start of the input to each break.
    :param s: a string to be split
    :return: a set of split segments
    """
    minor_breaks = '_.'
